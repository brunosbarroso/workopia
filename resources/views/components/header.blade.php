<header class="bg-blue-900 text-white p-4">
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-4">
            ...
            <x-nav-link url="/register" :active="request()->is('login')">Register</x-nav-link>
            <x-nav-link url="/dashboard" :active="request()->is('login')" icon="gauge">Dashboard</x-nav-link>
    ...
    >
        ...
        <x-nav-link url="/register" :active="request()->is('login')" :mobile="true">Register</x-nav-link>
        <x-nav-link url="/dashboard" :active="request()->is('login')" icon="gauge" :mobile="true">Dashboard</x-nav-link>
